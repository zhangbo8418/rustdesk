...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("allow-remote-toolbar-docking-any-edge", "允許遠端工具列停駐至任意邊緣"),
        ("API Token", "API 權杖"),
        ("Deploy", "部署"),
        ("Custom ID (optional)", "自訂 ID（選用）"),
        ("server_requires_deployment_tip", "伺服器要求明確部署此裝置。是否立即部署？"),
        ("The server does not require explicit deployment.", "伺服器不需要明確部署。"),
        ("Unknown response.", "未知回應。"),
        ("wayland-keyboard-input-disabled-tip", "允許鍵盤輸入？"),
        ("wayland-keyboard-input-consent-tip", "你在這台遠端電腦上輸入的內容（包括密碼）可能會被遠端電腦上的其他程式讀取。"),
        ...
        ("remember-wayland-keyboard-choice-tip", "之後對這台遠端電腦不再詢問"),
        ("Why this happens", "瞭解原因"),
    ].iter().cloned().collect();
}
